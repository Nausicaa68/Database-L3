...
(8, 'BONAPARTE', 'Napoléon','Ajaccio','0785479864'),
...
(7,'Patrie','protéger son pyas', 'responsabilité', 1000000000, '2011-12-17', 8, 6),
(8,'Musique','composer un nouveau chef d oeuvre', 'artistique', 800, '2021-11-01', 11, 9),
(9,'Batterie électrique','inventer une nouvelle baterrie électrique durable', 'écologique/économique', 500000, '2021-01-05', 12, 10),
(10,'Etudier','l_electromagnetisme', 'educatif', 0, '2019-07-11', 12, 10),
(11,'Ideal marxiste','instaurer cet idéal', 'politique', 55000, '1950-07-11', 9, 7),
(12,'BBQ','avec tous les habitants de Hell', 'loisir', 300, '2021-04-01', 6, 4),
(13,'35h','instaurer les 35h en Hell', 'économqiue', 0, '2021-04-01', 7, 5),
...
(1, 'road trip en corée', 'GRELAUD', FALSE, 10000, 2, 1, 3, 4),
(2, 'enquete ingé', 'GRELAUD', FALSE, 10, 2, 2, 2, 7),
...
(7, 'Réunion avec la DRI', 'ROSSIGNOL', FALSE, 0, 3, 6, 1, 6),
(8, 'Réunion avec la DRI n°2', 'ROSSIGNOL', FALSE, 0, 3, 8, 1, 6),
...
(13, 'revision systèmes linéaires', 'Helltaker', FALSE, 0, 4, 12, 6, 6),

(14, 'revision Théorie des graphes','DUMAS', FALSE, 0, 1, 13, 1, 2),
(15, 'revision Recherche opérationnelle', 'DUMAS', FALSE, 0, 1, 14, 1, 2),
...
(9, 'Conception de circuits numériques','Comprendre le VHDL', null, 1),
(11, 'base de données','Finir le porjet', '2021-11-14',1),
(12, 'anglais','réviser le vocabulaire', null, 1),
(13, 'systèmes linéaires','réviser la décomposition en éléments simples', null, 1),
(14, 'Théorie des graphes','réviser Bellman', null, 1),
(15, 'Recherche opérationnelle','réviser l algo de flot minimal', null, 1),
(16, 'HTML','réviser le programme avancé en html', null, 2),
